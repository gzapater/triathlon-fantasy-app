...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Note: The Race Participation Wizard Modal JavaScript that was here previously
    // (openParticipateWizardModal, closeParticipateWizardModal, renderWizardQuestion, etc.)
    // has been removed as per the new plan to reuse the existing answerQuinielaModal.
});
